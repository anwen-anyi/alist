...
FetchWebDev() {
  curl -L https://codeload.github.com/anwen-anyi/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/anwen-anyi/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
